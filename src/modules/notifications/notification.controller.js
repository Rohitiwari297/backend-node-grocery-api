...
export const addNotification = asyncHandler(async (req, res) => {
    ...
    logger.info(
        `Notification created for user {req.user._id}: ${title}`
    );
...
export const markAsRead = asyncHandler(async (req, res) => {
    ...
    logger.info(
        `Notification ${notificationId} marked as read by user ${req.user._id}`
    );
...
export const deleteNotification = asyncHandler(async (req, res) => {
    ...
    logger.info(
        `Notification ${notificationId} deleted by user ${req.user._id}`
    );
...
export const clearAllNotifications = asyncHandler(async (req, res) => {
    ...
    logger.info(
        `Cleared ${result.deletedCount} notifications for user ${req.user._id}`
    );

...
import { addUser, getUsers, updateUser, getUserById, getUserAddress, addUserAddress, deleteUserAddress } from './user.controller.js';
...
router.route('/address').get(getUserAddress).post(addUserAddress);

router.route('/address/:addressId').delete(deleteUserAddress);
